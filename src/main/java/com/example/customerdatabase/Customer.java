...
public class Customer {
    ...
    public Customer(String title, String firstName, String lastName, String streetAddress, String city, String state, String zipCode, String emailAddress, String position) {
        this.title = title;
        this.firstName = firstName;
        this.lastName = lastName;
        this.streetAddress = streetAddress;
